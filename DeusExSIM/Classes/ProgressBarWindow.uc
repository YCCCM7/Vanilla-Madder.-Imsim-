...
function UpdateBars()
{
	local Float valuePercent, UsePercent;
	...
	if (bUseScaledColor)
	{
		//MADDERS: Use to be 100 - but that shit is mad broken when using floats... Like it always has been.
		if (bUseInverseColor) valuePercent = FMax(0.01, 1.0 - valuePercent);
