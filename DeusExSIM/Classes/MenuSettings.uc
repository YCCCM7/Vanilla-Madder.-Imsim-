...
defaultproperties
{
     ...
     buttonDefaults(6)=(Y=229,Action=MA_MenuScreen,Invoke=Class'DeusEx.VMDMenuOptionsImproved')
     buttonDefaults(7)=(Y=266,Action=MA_Previous)
     Title="Settings"
     ClientWidth=294
     ClientHeight=308
     clientTextures(0)=Texture'VMDMenuOptionsBackground1'
     clientTextures(1)=Texture'VMDMenuOptionsBackground2'
     clientTextures(2)=Texture'MenuOptionsBackground_3'
     clientTextures(3)=Texture'MenuOptionsBackground_4'
     textureCols=2
}
