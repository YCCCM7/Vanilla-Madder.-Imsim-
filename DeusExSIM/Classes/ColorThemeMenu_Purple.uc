//=============================================================================
// ColorThemeMenu_Purple
//=============================================================================

class ColorThemeMenu_Purple extends ColorThemeMenu;
...
defaultproperties
{
     ...
     DefaultColors(0)=(R=214,G=177,B=255)
     DefaultColors(1)=(R=255,B=255)
     DefaultColors(2)=(R=249,G=239,B=255)
     DefaultColors(3)=(R=212,G=190,B=242)
     DefaultColors(4)=(R=209,G=201,B=212)
     DefaultColors(5)=(R=249,G=239,B=255)
     DefaultColors(6)=(R=83,G=72,B=97)
     DefaultColors(7)=(R=188,G=177,B=200)
     DefaultColors(8)=(R=188,G=177,B=200)
     DefaultColors(9)=(R=255,G=255,B=255)
     DefaultColors(10)=(R=77,G=54,B=91)
     DefaultColors(11)=(R=143,G=121,B=156)
     DefaultColors(12)=(R=214,G=177,B=255)
}
