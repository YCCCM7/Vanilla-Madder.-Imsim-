...
defaultproperties
{
     ...
     LevelValues(1)=1.500000 //Used to be 2.0, then 1.5. Then, 1.67 for 50 points. Now it's 1.5 for 45 points.
     LevelValues(2)=2.000000 //Used to be 2.5, then 2.25. Then, 2.34 for 70 points. Now it's 2.0 for 60 points.
     LevelValues(3)=2.500000 //Used to be 3.0 for 90 points. Now it's 2.5 for 75 points.
}
