...
function VMDSetSkinColor(byte NewSkin)
{
	switch(NewSkin)
	{
		case 0: SkinColor = SC_Biohazard; break;
		case 1: SkinColor = SC_Blue; break;
		case 2: SkinColor = SC_Brown; break;
		case 3: SkinColor = SC_Rusty; break;
		case 4: SkinColor = SC_Explosive; break;
		case 5: SkinColor = SC_FlammableLiquid; break;
		case 6: SkinColor = SC_FlammableSolid; break;
		case 7: SkinColor = SC_Poison; break;
		case 8: SkinColor = SC_Radioactive; break;
		case 9: SkinColor = SC_Wood; break;
		case 10: SkinColor = SC_Yellow; break;
	}
}
	...
	function Tick(float deltaTime)
	{
		...
		if (SkinColor == SC_RadioActive)
		{
			...
			if (radTimer > 1.0)
			{
				...
				{
					if ((A != None) && (FastTrace(A.Location, Location)))
					{
		...
		if (Damage >= minDamageThreshold)
		{
			...
			if (!bLeaking)
			{
				...
				if (((SkinColor == SC_Biohazard) || (SkinColor == SC_Poison)) &&
					(HitPoints-Damage > 0) && (DamageType != 'Exploded'))
				{
				...
				if (((SkinColor == SC_Explosive) || (SkinColor == SC_FlammableLiquid) ||
					 (SkinColor == SC_FlammableSolid)) && (HitPoints-Damage > 0) && (DamageType != 'Exploded'))
				{
					size = CollisionRadius / 54.0;
					size = FClamp(size, 0.1, 4.0);
