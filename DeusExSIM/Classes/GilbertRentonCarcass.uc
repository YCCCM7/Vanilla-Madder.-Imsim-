...
//=============================================================================
class GilbertRentonCarcass extends DeusExCarcass;

defaultproperties
{
     FamiliarName="Gilbert Renton" // Transcended - Added
     Mesh2=LodMesh'TranscendedModels.TransGM_Trench_F_CarcassB'
     Mesh3=LodMesh'TranscendedModels.TransGM_Trench_F_CarcassC'
     Mesh=LodMesh'TranscendedModels.TransGM_Trench_F_Carcass'
