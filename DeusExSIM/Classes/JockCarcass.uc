...
// JockCarcass.
//=============================================================================
class JockCarcass extends DeusExCarcass;

defaultproperties
{
     FamiliarName="Jock" // Transcended - Added
     Mesh2=LodMesh'TranscendedModels.TransGM_Trench_CarcassB'
     Mesh3=LodMesh'TranscendedModels.TransGM_Trench_CarcassC'
     Mesh=LodMesh'TranscendedModels.TransGM_Trench_Carcass'
     MultiSkins(0)=Texture'DeusExCharacters.Skins.JockTex0'
     MultiSkins(1)=Texture'JockTex2'
