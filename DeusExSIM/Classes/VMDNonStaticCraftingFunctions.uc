...
defaultproperties
{
      ...
      MechanicalItemsGlossary(11)=class'Ammo10mm'
      MechanicalItemsGlossary(12)=class'Ammo3006'
      MechanicalItemsGlossary(13)=class'Ammo762mm'
      MechanicalItemsGlossary(14)=class'AmmoShell'
      MechanicalItemsGlossary(15)=class'AmmoRocket'
      MechanicalItemsGlossary(16)=class'Ammo10mmHEAT'
      MechanicalItemsGlossary(17)=class'Ammo3006HEAT'
      MechanicalItemsGlossary(18)=class'AmmoDragonsBreath'
      MechanicalItemsGlossary(19)=class'AmmoTaserSlug'
      MechanicalItemsGlossary(20)=class'AmmoSabot'
      MechanicalItemsGlossary(21)=class'AmmoRocketWP'
      MechanicalItemsGlossary(22)=class'AmmoRocketEMP'
      ...
      MechanicalItems(15)=class'AmmoRocket'
      MechanicalItemsPrice(15)=200
      MechanicalItemsQuanMade(15)=4
      MechanicalItemsSkillReq(15)=2
      MechanicalItemsComplexity(15)=2
      MechanicalItemsItemReqA(15)=class'WeaponLAM'
      MechanicalItemsQuanReqA(15)=1
      MechanicalItemsItemReqB(15)=class'VMDEmptyGrenade'
      MechanicalItemsQuanReqB(15)=2
      MechanicalBreakdowns(13)=class'AmmoRocket'
      MechanicalBreakdownsPrice(13)=250
      ...
      MechanicalItems(19)=class'AmmoDragonsBreath'
      MechanicalItemsPrice(19)=300
      ...
      MechanicalItemsQuanReqB(19)=50
      MechanicalBreakdowns(17)=class'AmmoDragonsBreath'
      MechanicalBreakdownsPrice(17)=500
      MechanicalBreakdownsQuanNeeded(17)=8
      
      MechanicalItems(20)=class'AmmoTaserSlug'
      MechanicalItemsPrice(20)=200
      MechanicalItemsQuanMade(20)=8
      MechanicalItemsSkillReq(20)=3
      MechanicalItemsComplexity(20)=2
      MechanicalItemsItemReqA(20)=class'AmmoSabot'
      MechanicalItemsQuanReqA(20)=4
      MechanicalItemsItemReqB(20)=class'AmmoBattery'
      MechanicalItemsQuanReqB(20)=8
      MechanicalBreakdowns(18)=class'AmmoTaserSlug'
      MechanicalBreakdownsPrice(18)=350
      MechanicalBreakdownsQuanNeeded(18)=8
      
      MechanicalItems(21)=class'AmmoRocketWP'
      MechanicalItemsPrice(21)=200
      MechanicalItemsQuanMade(21)=4
      MechanicalItemsSkillReq(21)=3
      MechanicalItemsComplexity(21)=2
      MechanicalItemsItemReqA(21)=class'AmmoRocket'
      MechanicalItemsQuanReqA(21)=4
      MechanicalItemsItemReqB(21)=class'AmmoNapalm'
      MechanicalItemsQuanReqB(21)=100
      MechanicalBreakdowns(19)=class'AmmoRocketWP'
      MechanicalBreakdownsPrice(19)=350
      MechanicalBreakdownsQuanNeeded(19)=4
      
      MechanicalItems(22)=class'AmmoRocketEMP'
      ...
      MechanicalItemsItemReqB(22)=class'WeaponEMPGrenade'
      MechanicalItemsQuanReqB(22)=1
      MechanicalBreakdowns(20)=class'AmmoRocketEMP'
      MechanicalBreakdownsPrice(20)=300
