...
//MADDERS, 1/28/21: We don't have these anims, so cheat.
...
function PlayEating()
{
	if (HasAnim('Still')) PlayAnimPivot('Still', 1.3, 0.2);
}
...
{
     bInsignificant=True
     FoodClass=Class'DeusEx.FleshFragment'
     FoodDamage=5
     FoodHealth=2
     bMessyEater=True
     ...
     Alliance=Rat
     DrawType=DT_Mesh
     Mesh=LodMesh'TranscendedModels.TransRat'
