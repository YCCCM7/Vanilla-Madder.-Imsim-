...
//=============================================================================
class ScientistFemaleCarcass extends DeusExCarcass;

defaultproperties
{
     FamiliarName="Scientist" // Transcended - Added
     Mesh2=LodMesh'TranscendedModels.TransGFM_Trench_CarcassB'
     Mesh3=LodMesh'TranscendedModels.TransGFM_Trench_CarcassC'
     Mesh=LodMesh'TranscendedModels.TransGFM_Trench_Carcass'
