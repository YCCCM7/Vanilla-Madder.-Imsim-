//=============================================================================
// ColorThemeMenu_CoolGreen
//=============================================================================

class ColorThemeMenu_CoolGreen extends ColorThemeMenu;
...
defaultproperties
{
     ...
     DefaultColors(0)=(R=96,G=255,B=194)
     DefaultColors(1)=(G=255,B=217)
     DefaultColors(2)=(R=214,G=255,B=237)
     DefaultColors(3)=(R=86,G=255,B=166)
     DefaultColors(4)=(R=62,G=217,B=143)
     DefaultColors(5)=(R=191,G=255,B=215)
     DefaultColors(6)=(G=163,B=121)
     DefaultColors(7)=(R=191,G=255,B=215)
     DefaultColors(8)=(R=23,G=217,B=143)
     DefaultColors(9)=(R=191,G=255,B=215)
     DefaultColors(10)=(G=134,B=83)
     DefaultColors(11)=(R=73,G=255,B=177)
     DefaultColors(12)=(R=96,G=255,B=194)
}
