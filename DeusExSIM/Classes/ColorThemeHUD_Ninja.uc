...
class ColorThemeHUD_Ninja extends ColorThemeHUD;
...
defaultproperties
{
     ...
     DefaultColors(0)=(R=100,G=100,B=100)
     DefaultColors(1)=(R=255,G=255,B=255)
     DefaultColors(2)=(R=255,G=255,B=255)
     DefaultColors(3)=(R=100,G=100,B=100)
     DefaultColors(4)=(R=128,G=128,B=128)
     ...
     DefaultColors(12)=(R=220,G=220,B=220)
