...
defaultproperties
{
     ...
     buttonDefaults(5)=(Y=301,Action=MA_MenuScreen,Invoke=Class'DeusEx.VMDMenuTrainingSelection')
     buttonDefaults(6)=(Y=193,Action=MA_Intro)
     buttonDefaults(7)=(Y=229,Action=MA_MenuScreen,Invoke=Class'DeusEx.CreditsWindow')
     buttonDefaults(8)=(Y=265,Action=MA_Previous)
