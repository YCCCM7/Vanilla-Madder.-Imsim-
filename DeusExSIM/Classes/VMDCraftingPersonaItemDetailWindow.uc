//=============================================================================
// VMDCraftingPersonaItemDetailWindow
//=============================================================================
class VMDCraftingPersonaItemDetailWindow extends PersonaBaseWindow;

var VMDCraftingPersonaItemDetailButton winIcon;
...
{
	winIcon = VMDCraftingPersonaItemDetailButton(NewChild(Class'VMDCraftingPersonaItemDetailButton'));
	winIcon.SetPos(8, 0);
...
function VMDCraftingPersonaItemDetailButton GetItemButton()
{
	return winIcon;
}
...
function SetCount(int newCount, int NewMax)
{
	if (winIcon != None)
		winIcon.SetCount(newCount, NewMax);
}
