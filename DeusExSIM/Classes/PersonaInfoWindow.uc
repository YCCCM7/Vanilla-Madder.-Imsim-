...
// PersonaInfoWindow
//=============================================================================
class PersonaInfoWindow extends PersonaBaseWindow;

var PersonaScrollAreaWindow	 winScroll;
var TileWindow			 winTile;

//MADDERS, 8/16/23: Biomod port stuff.
var PersonaHeaderTextWindow	 winTitle;
//var PersonaRenameWindow 	 winTitle;
...
function CreateControls()
{
	...
	//winTitle = PersonaRenameWindow(NewChild(Class'PersonaRenameWindow'));
	winTitle.SetTextMargins(2, 1);
	
	//MADDERS, 8/16/23: We're not porting aug renaming. Doesn't seem relevant.
	//UPDATE: Don't use this class AT ALL, it's buggy as hell for some reason.
	//winTitle.EnableEditing(True);
	//winTitle.EnableSingleLineEditing(True);
	//winTitle.EnableEditing(False);
	//winTitle.EnableSingleLineEditing(False);
	//winTitle.SetMaxSize(40);
	//winTitle.SetFont(Font'DeusExUI.FontMenuHeaders');
