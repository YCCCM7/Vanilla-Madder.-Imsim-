...
defaultproperties
{
     ...
     InitialAlliances(0)=(AllianceName=Rat,AllianceLevel=-1.000000,bPermanent=True) // Transcended - Added
     ...
     Alliance=Cat
     DrawType=DT_Mesh
     Mesh=LodMesh'TranscendedModels.TransCat'
