...
// Mission12.
//=============================================================================
class Mission12 extends MissionScript;
		...
		if (!flags.GetBool('CapturedScientistRescued'))
		{
			...
			foreach AllActors(class'MJ12Troop', troop)
			{
				if ((troop.Tag == 'MJ12_hazlab_troop1') || (troop.Tag == 'MJ12_hazlab_troop2'))
					count++;
				else if ((troop.BindName == "MJ12_hazlab_troop1") || (troop.BindName == "MJ12_hazlab_troop2")) // Transcended - Incorrectly assigned to BindName by default in map
					count++;
			}
