...
defaultproperties
{
     ...
     strDescription(29)="Whether the display of how focused your aim is, which acts a sort of secondary crosshair."
     ...
     strSetting(34)="Health Portrait Visibility"
     varSetting(34)="bHitDisplayVisible"
     strDescription(34)="Whether or not the paper doll of your character's health is displayed, along with its various bars and a directional damage indicator."
     strSetting(35)="Hit Indicator Icon"
     varSetting(35)="bHitIndicatorHasVisual"
     strDescription(35)="If enabled, hits on enemies will be reflected with an indicator on your HUD. White shows a standard hit. Yellow shows an armor hit. Red shows a critical hit. Orange shows both."
     strSetting(36)="Hit Indicator Sound"
     varSetting(36)="bHitIndicatorHasAudio"
     strDescription(36)="If enabled, headshots are reinforced with a 'crunch' sound, for satisfying feedback when you perform well, as well as giving clearer feedback."
     strSetting(37)="Item Highlight Borders"
     varSetting(37)="bFrobDisplayBordersVisible"
     strDescription(37)="Whether or not to display a bounding box around objects within touching range."
     strSetting(38)="Light Gem Visibility"
     varSetting(38)="bLightGemVisible"
     strDescription(38)="Whether or not to display a light gem that recolors itself based on how exposed you are to enemy vision."
     strSetting(39)="Log Visibility"
     varSetting(39)="bLogVisible"
     strDescription(39)="Whether or not to display a text log with information and various flavor messages specific to VMD."
     strSetting(40)="Object Belt Visibility"
     varSetting(40)="bObjectBeltVisible"
     strDescription(40)="Whether or not the object belt is displayed."
     strSetting(41)="Object Name Visibility"
     varSetting(41)="bObjectNames"
     strDescription(41)="Whether or not to display item names for objects within touching range."
     strSetting(42)="Skill Notifier Visibility"
     varSetting(42)="bSkillNotifierVisible"
     strDescription(42)="Whether or not to display icons notifying you of new skill rank ups being possible."
     strSetting(43)="Smell Indicator Visibility"
     varSetting(43)="bSmellIndicatorVisible"
     strDescription(43)="Whether or not to display a set of icons related to active smells. They can always be checked in the status screen."
     strSetting(44)="Subtitles Visibility"
     varSetting(44)="bSubtitles"
     strDescription(44)="Whether or not to display subtitles during conversations."
     ...
     strSetting(46)="----Gameplay Systems------------"
     varSetting(46)="BARF"
     OverrideLabelValues(46)="----"
     strDescription(46)=""
     
     OverrideSettingCaps(47)=3
     strSetting(47)="Addiction System"
     varSetting(47)="bAddictionEnabled"
     strDescription(47)="Set to what degree you can get addicted to substances: None, Major, or All. Minor is comprised of petty things such as sugar and caffeine."
     OverrideLabelValues(47)="Off|Major|All"
     strSetting(48)="Crafting System"
     varSetting(48)="bCraftingSystemEnabled"
     strDescription(48)="Enable or disable a crafting system, incorporating both Medicine and Hardware skills. On Nightmare and higher difficulty, this will also replace some loot sources with chemicals and scrap."
     strSetting(49)="Instant Crafting"
     varSetting(49)="bUseInstantCrafting"
     strDescription(49)="If enabled, Hardware-based and Medicine-based crafting occurs instantly, and will not close menus unnecessarily."
     strSetting(50)="Environmental Sounds"
     varSetting(50)="bEnvironmentalSoundsEnabled"
     strDescription(50)="If enabled, select sounds will play in the environment, but for immersive purposes. This includes the heartbeat sound at high stress and crafting sounds."
     strSetting(51)="Hunger System"
     varSetting(51)="bHungerEnabled"
     strDescription(51)="Toggle whether you require food to sustain yourself. This system aims to be immersive and discourage save abuse on Gallows difficulty."
     strSetting(52)="Hunger Bio Usage"
     varSetting(52)="bBioHungerEnabled"
     strDescription(52)="Toggle whether bio energy will be consumed instead of taking damage, if hunger runs out."
     strSetting(53)="Immersive Killswitch"
     varSetting(53)="bImmersiveKillswitch"
     strDescription(53)="Toggle whether any situations with the killswitch will apply debuffs. This system aims to add immersion and challenge."
     strSetting(54)="Smell System"
     varSetting(54)="bSmellsEnabled"
     strDescription(54)="Toggle whether foods and blood can produce smell profiles. This system aims to be immersive and discourages excessive food storage and especially excessive murder."
     strSetting(55)="Skill Talents System"
     varSetting(55)="bSkillAugmentsEnabled"
     strDescription(55)="Enable or disable the talents system on top of normal skill progression. These add functional upgrades. When disabled, 'essential' talents will be treated as if boughten."
     strSetting(56)="Stress System"
     varSetting(56)="bStressEnabled"
     strDescription(56)="Toggle whether injuries and environmental factors can make your character get stressed. If enabled, good management gives benefit vs no stress system at all."
     ...
     strDescription(57)=""
     OverrideSettingCaps(58)=1
     strSetting(58)="----Misc Settings------------"
     varSetting(58)="BARF"
     OverrideLabelValues(58)="----"
     strDescription(58)=""
     
     strSetting(59)="Allow Any NG Plus"
     varSetting(59)="bAllowAnyNGPlus"
     strDescription(59)="If enabled, female JCs are allowed to NG plus into campaigns with improper use of pronouns, which may otherwise harm immersion."
     strSetting(60)="Allow Female JC"
     varSetting(60)="bAllowFemJC"
     strDescription(60)="Enable this if the Lay D Denton Project (or another parallel project) is installed."
     strSetting(61)="Allow Vanilla Reskins"
     varSetting(61)="bVanillaReskinsEnabled"
     strDescription(61)="If enabled, non-critical NPCs throughout the vanilla campaign will have their skins updated. This setting is only applied during a map's first load."
     
     //strSetting(62)="Direct Mouse Input"
     //varSetting(62)="BarfUseDirectInput"
     //strDescription(62)="If enabled, direct mouse input will be used instead of standard mouse input. This may solve weird mouse movement for some users. Requires a game restart to take effect."
     
     strSetting(63)="MEGH Recon Ping"
     varSetting(63)="bMEGHRadarPing"
     strDescription(63)="If enabled, the MEGH drone will produce radar pings when spotting targets for the first time."
     strSetting(64)="Modded NG Music"
     varSetting(64)="bModdedCharacterSetupMusic"
     strDescription(64)="If enabled, non-vanilla campaigns may change out the character setup music with their main theme. Ya' know. For fun factor."
     OverrideSettingCaps(65)=4
     strSetting(65)="Realistic Roll Camera"
     varSetting(65)="bRealisticRollCamera"
     strDescription(65)="If enabled, using talents to roll around will move your camera like it would in real life. This can affect either the dodge roll, the fall/tactical roll, or both."
     OverrideLabelValues(65)="Off|Dodge|Fall|Both"
     strSetting(66)="Immersive Player Hands"
     varSetting(66)="bPlayerHandsEnabled"
     strDescription(66)="If enabled, your empty hands will draw your actual hands on your screen, instead of nothing."
     strSetting(67)="Jump Duck Sound"
     varSetting(67)="bJumpDuckFeedbackNoise"
     strDescription(67)="If enabled, Fit as a Fiddle's jump duck will make a noise for more feedback."
     strSetting(68)="Realtime UI"
     varSetting(68)="bRealtimeUI"
     strDescription(68)="If enabled, menus won't pause the game (except for certain crafting windows, the main menu, and the controller-friendly aug menu)"
     strSetting(69)="Realtime Controller Augs"
     varSetting(69)="bRealtimeControllerAugs"
     strDescription(69)="If enabled, the controller-friendly aug menu will play in real time, instead of pausing the game. This is not affected by the above setting."
}
