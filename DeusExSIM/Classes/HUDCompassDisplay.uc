...
// HUDCompassDisplay
//=============================================================================
class HUDCompassDisplay extends HUDBaseWindow;
...
event Tick(float deltaSeconds)
{
	...
	if (lastPlayerYaw != player.Rotation.Yaw)
	{
		...
		if ((VMDBufferPlayer(Player) != None) && (VMDBufferPlayer(Player).HUDScramblerTimer > 0))
		{
			LastPlayerYaw += 65536 * (VMDBufferPlayer(Player).HUDScramblerTimer % 1.35);
		}
