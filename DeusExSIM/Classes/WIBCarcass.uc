...
// WIBCarcass.
//=============================================================================
class WIBCarcass extends DeusExCarcass;

defaultproperties
{
     FamiliarName="Woman in Black" // Transcended - Added
     bExplosive=True
     Mesh2=LodMesh'TranscendedModels.TransGFM_SuitSkirt_CarcassB'
     Mesh3=LodMesh'TranscendedModels.TransGFM_SuitSkirt_CarcassC'
     Mesh=LodMesh'TranscendedModels.TransGFM_SuitSkirt_Carcass'
     DrawScale=1.100000
