//=============================================================================
// ColorThemeMenu_PaleGreen
//=============================================================================

class ColorThemeMenu_PaleGreen extends ColorThemeMenu;
...
defaultproperties
{
     ...
     DefaultColors(0)=(R=218,G=255,B=196)
     DefaultColors(1)=(G=242,B=230)
     DefaultColors(2)=(R=255,G=255,B=206)
     DefaultColors(3)=(R=241,G=255,B=202)
     DefaultColors(4)=(R=180,G=211,B=178)
     DefaultColors(5)=(R=255,G=255,B=206)
     DefaultColors(6)=(R=70,G=70,B=70)
     DefaultColors(7)=(R=155,G=186,B=153)
     DefaultColors(8)=(R=155,G=186,B=153)
     DefaultColors(9)=(R=255,G=255,B=206)
     DefaultColors(10)=(G=108,B=84)
     DefaultColors(11)=(G=185,B=166)
     DefaultColors(12)=(R=218,G=255,B=196)
}
