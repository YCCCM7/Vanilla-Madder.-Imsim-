...
var string SkillAugmentName, SkillAugmentDesc;
var name SkillAugmentID;
var int SkillLevel, SecondarySkillLevel, PageNumber, BorderX, BorderY;

function SetSkillData(name NewSkillAugmentID, string NewSkillAugmentName, string NewSkillAugmentDesc, int NewSkillLevel, int NewSecondarySkillLevel, int NewPageNumber)
{
