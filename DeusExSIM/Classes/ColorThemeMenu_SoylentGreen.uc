//=============================================================================
// ColorThemeMenu_SoylentGreen
//=============================================================================

class ColorThemeMenu_SoylentGreen extends ColorThemeMenu;
...
defaultproperties
{
     ...
     DefaultColors(7)=(R=80,G=145,B=105)
     DefaultColors(8)=(R=80,G=145,B=105)
     DefaultColors(9)=(R=70,G=160,B=100)
     DefaultColors(10)=(B=30)
     DefaultColors(11)=(R=80,G=145,B=105)
