//=============================================================================
// ColorThemeMenu_Ninja
//=============================================================================

class ColorThemeMenu_Ninja extends ColorThemeMenu;
...
defaultproperties
{
     ...
     DefaultColors(1)=(R=40,G=40,B=40)
     DefaultColors(2)=(R=200,G=200,B=200)
     DefaultColors(3)=(R=40,G=40,B=40)
     DefaultColors(4)=(R=150,G=150,B=150)
     DefaultColors(5)=(R=255,G=255,B=255)
     DefaultColors(6)=(R=48,G=48,B=48)
     DefaultColors(7)=(R=175,G=175,B=175)
     DefaultColors(8)=(R=175,G=175,B=175)
     DefaultColors(9)=(R=255,G=255,B=255)
     DefaultColors(11)=(R=220,G=220,B=220)
