...
// InterpolateTrigger.
//=============================================================================
class InterpolateTrigger extends Trigger;
...
function bool SendActorOnPath()
{
	...
	foreach AllActors (class'Actor', A, Event)
		if ((A != None) && !A.IsA('InterpolationPoint') && !A.IsA('Triggers'))
		{
			foreach AllActors (class'InterpolationPoint', I, A.Event)
			{
				if ((I != None) && (I.Position == 1))		// start at 1 instead of 0 - put 0 at the object's initial position
				{
