//=============================================================================
// ColorThemeMenu_Primaries
//=============================================================================

class ColorThemeMenu_Primaries extends ColorThemeMenu;
...
defaultproperties
{
     ...
     DefaultColors(1)=(R=100)
     DefaultColors(2)=(R=250,G=253)
     DefaultColors(3)=(R=108)
     DefaultColors(4)=(R=200,G=200)
     DefaultColors(5)=(R=255,G=255,B=255)
     DefaultColors(6)=(B=46)
     DefaultColors(7)=(R=175,G=175,B=175)
     DefaultColors(8)=(R=142)
     DefaultColors(9)=(R=255,G=255)
     DefaultColors(10)=(R=67)
     DefaultColors(11)=(R=166)
