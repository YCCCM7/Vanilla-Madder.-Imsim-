//=============================================================================
// PersonaUnFullscreenButton
//=============================================================================

class PersonaUnFullscreenButton extends PersonaBorderButtonWindow;
...
defaultproperties
{
     ...
     Center_Textures(0)=(Tex=Texture'VMDAssets.VMDMinimizeButtonNormalCenter',Width=16)
     Center_Textures(1)=(Tex=Texture'VMDAssets.VMDMinimizeButtonPressedCenter',Width=16)
     buttonHeight=16
