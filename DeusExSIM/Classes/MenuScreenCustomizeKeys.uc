...
//=============================================================================
class MenuScreenCustomizeKeys extends MenuUIScreenWindow;
...
defaultproperties
{
     ...
     FunctionText(38)="Player Appearance Screen"
     ...
     FunctionText(47)="Augmentation Slot F3"
     FunctionText(48)="Augmentation Slot F4"
     FunctionText(49)="Augmentation Slot F5"
     FunctionText(50)="Augmentation Slot F6"
     FunctionText(51)="Augmentation Slot F7"
     FunctionText(52)="Augmentation Slot F8"
     FunctionText(53)="Augmentation Slot F9"
     FunctionText(54)="Augmentation Slot F10"
     FunctionText(55)="Augmentation Slot F11"
     FunctionText(56)="Augmentation Slot F12"
     FunctionText(57)="Toggle Firing Mode"
     FunctionText(58)="Issue Drone Order"
     FunctionText(59)="Controller-Friendly Aug Menu"
     FunctionText(60)="Controller-Friendly Health Menu"
     FunctionText(61)="Quick Hardware Crafting Menu"
     FunctionText(62)="Quick Medicine Crafting Menu"
     FunctionText(63)="(Mutations) Show Level Map"
     FunctionText(64)="Show Multiplayer Scores"
     FunctionText(65)="Send Message To Team"
     FunctionText(66)="Send Message To All"
     FunctionText(67)="Activate Multiplayer Skill Menu"
     FunctionText(68)="Show Multiplayer Kill Details"
     ...
     AliasNames(38)="ModifyPlayerAppearance"
     ...
     AliasNames(57)="ToggleFiringMode"
     AliasNames(58)="IssueDroneOrder"
     AliasNames(59)="OpenControllerAugWindow"
     AliasNames(60)="OpenControllerHealthWindow"
     AliasNames(61)="OpenMechanicalCraftingWindow"
     AliasNames(62)="OpenMedicalCraftingWindow"
     AliasNames(63)="ShowMap"
     AliasNames(64)="ShowScores"
     AliasNames(65)="TeamTalk"
     AliasNames(66)="Talk"
     AliasNames(67)="BuySkills"
     AliasNames(68)="KillerProfile"
