...
// VMDLockpick
//
/*#exec MESH IMPORT MESH=VMDLockpickLeft ANIVFILE=Models\LeftHanded3rdImports\VMDLockpickLeft_a.3d DATAFILE=Models\LeftHanded3rdImports\VMDLockpickLeft_d.3d ZEROTEX=1 UNMIRROR=1
#exec MESHMAP SCALE MESHMAP=VMDLockpickLeft X=0.00390625 Y=0.00390625 Z=0.00390625
#exec MESH SEQUENCE MESH=VMDLockpickLeft SEQ=All		STARTFRAME=0	NUMFRAMES=1
#exec MESH SEQUENCE MESH=VMDLockpickLeft SEQ=Still		STARTFRAME=0	NUMFRAMES=1
#exec MESH SEQUENCE MESH=VMDLockpickLeft SEQ=Select	STARTFRAME=0	NUMFRAMES=1
#exec MESH SEQUENCE MESH=VMDLockpickLeft SEQ=Idle1		STARTFRAME=0	NUMFRAMES=1
#exec MESH SEQUENCE MESH=VMDLockpickLeft SEQ=Idle2		STARTFRAME=0	NUMFRAMES=1
#exec MESH SEQUENCE MESH=VMDLockpickLeft SEQ=Idle3		STARTFRAME=0	NUMFRAMES=1

#exec MESHMAP SETTEXTURE MESHMAP=VMDLockpickLeft NUM=0 TEXTURE=LockpickTex1

//
// VMDLockpick3rd
//
#exec MESH IMPORT MESH=VMDLockpick3rdLeft ANIVFILE=Models\LeftHanded3rdImports\VMDLockpick3rdLeft_a.3d DATAFILE=Models\LeftHanded3rdImports\VMDLockpick3rdLeft_d.3d
#exec MESH ORIGIN MESH=VMDLockpick3rdLeft X=0 Y=0 Z=0 PITCH=-64
#exec MESHMAP SCALE MESHMAP=VMDLockpick3rdLeft X=0.00390625 Y=0.00390625 Z=0.00390625
#exec MESH SEQUENCE MESH=VMDLockpick3rdLeft SEQ=All	STARTFRAME=0	NUMFRAMES=1
#exec MESH SEQUENCE MESH=VMDLockpick3rdLeft SEQ=Still	STARTFRAME=0	NUMFRAMES=1
#exec MESH SEQUENCE MESH=VMDLockpick3rdLeft SEQ=Select	STARTFRAME=0	NUMFRAMES=1
#exec MESH SEQUENCE MESH=VMDLockpick3rdLeft SEQ=Idle1	STARTFRAME=0	NUMFRAMES=1
#exec MESH SEQUENCE MESH=VMDLockpick3rdLeft SEQ=Idle2	STARTFRAME=0	NUMFRAMES=1
#exec MESH SEQUENCE MESH=VMDLockpick3rdLeft SEQ=Idle3	STARTFRAME=0	NUMFRAMES=1

#exec MESHMAP SETTEXTURE MESHMAP=VMDLockpick3rdLeft NUM=0 TEXTURE=LockpickTex1*/
