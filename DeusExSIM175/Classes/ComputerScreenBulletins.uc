...
function SetNetworkTerminal(NetworkTerminal newTerm)
{
	...
	if ((Human(Player) != None) && (Human(player).bEmailSavingOption))
	{
...
function bool ButtonActivated( Window buttonPressed )
{
	...
	switch( buttonPressed )
	{
		...
		case btnAddLog:
			if (winBulletin.GetText() != "" && winBulletin.GetText() != NoBulletinsTodayText)
				player.AddNote(winBulletin.GetText(),, True, "Emails");
			btnAddLog.SetSensitivity(False);
			break;
