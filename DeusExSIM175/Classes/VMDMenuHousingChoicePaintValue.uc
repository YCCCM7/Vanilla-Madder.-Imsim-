...
//=============================================================================
class VMDMenuHousingChoicePaintValue extends MenuUIChoice;
...
var localized string LabelRed, LabelGreen, LabelBlue;

function SetColor(int NewColor, int NewWidth, int CurValue)
{
	local int i;
	...
	{
		case 0:
			BtnAction.SetButtonText(LabelRed);
		break;
		case 1:
			BtnAction.SetButtonText(LabelGreen);
		break;
		case 2:
			BtnAction.SetButtonText(LabelBlue);
		break;
	}
	
	for (i=0; i<NumTicks; i++)
	{
		SetEnumeration(i, 1+int(float(i) * (255.0 / NumTicks)));
	}
