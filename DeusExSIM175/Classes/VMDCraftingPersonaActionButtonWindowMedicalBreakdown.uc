//=============================================================================
// VMDCraftingPersonaActionButtonWindowMedicalBreakdown
//=============================================================================
class VMDCraftingPersonaActionButtonWindowMedicalBreakdown extends PersonaActionButtonWindow;

var Class<Inventory> BreakdownClass;
var int QuantityNeeded, ChemicalsGain;
