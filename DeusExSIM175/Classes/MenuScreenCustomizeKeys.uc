...
defaultproperties
{
     ...
     FunctionText(58)="(Mutations) Show Level Map"
     FunctionText(59)="Show Multiplayer Scores"
     FunctionText(60)="Send Message To Team"
     FunctionText(61)="Send Message To All"
     FunctionText(62)="Activate Multiplayer Skill Menu"
     FunctionText(63)="Show Multiplayer Kill Details"
     ...
     AliasNames(58)="ShowMap"
     AliasNames(59)="ShowScores"
     AliasNames(60)="TeamTalk"
     AliasNames(61)="Talk"
     AliasNames(62)="BuySkills"
     AliasNames(63)="KillerProfile"
