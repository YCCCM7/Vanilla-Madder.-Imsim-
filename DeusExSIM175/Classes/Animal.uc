	...
	if (!bInvincible)
	{
		switch(HitPos)
		{
		 	case HITLOC_HeadBack:
				if ((bClosedSystemHit) && (VMDBufferPlayer(GetPlayerPawn()) != None) && (VMDBufferPlayer(GetPlayerPawn()).HasSkillAugment("TagTeamClosedHeadshot")))
				{
