...
//++++++++++++++++++++++++
//MADDERS ADDITIONS!
var bool bDidSetup, bEverNotFrobbed, bDidItemDrop;
...
//			return;
	...
	if ((bPushable) && (PlayerPawn(Other) != None) && (Other.Mass > 40) && (float(Other.GetPropertyText("RollTimer")) <= 0))// && (Physics != PHYS_Falling))
	{
