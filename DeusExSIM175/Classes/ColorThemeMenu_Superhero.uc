//=============================================================================
// ColorThemeMenu_Superhero
//=============================================================================

class ColorThemeMenu_Superhero extends ColorThemeMenu;
...
defaultproperties
{
     ...
     DefaultColors(0)=(R=45,G=156,B=255)
     DefaultColors(1)=(R=167,G=24)
     DefaultColors(2)=(R=255,G=255,B=255)
     DefaultColors(3)=(R=255,G=255,B=202)
     DefaultColors(4)=(R=255,G=255,B=255)
     DefaultColors(5)=(R=255,G=255)
     DefaultColors(6)=(R=89,G=89,B=61)
     DefaultColors(7)=(R=255,G=255,B=255)
     DefaultColors(8)=(R=177,G=24)
     DefaultColors(9)=(R=255,G=255,B=252)
     DefaultColors(10)=(B=41)
     DefaultColors(11)=(R=255,G=255,B=142)
