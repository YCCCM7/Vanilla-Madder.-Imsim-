...
class ColorThemeMenu_Dusk extends ColorThemeMenu;
...
defaultproperties
{
     ...
     DefaultColors(1)=(R=84,B=84)
     DefaultColors(2)=(R=255,G=175)
     DefaultColors(3)=(R=84,B=84)
     DefaultColors(4)=(R=255,G=175)
     DefaultColors(5)=(R=255,G=255,B=255)
     DefaultColors(6)=(R=255,G=99,B=255)
     DefaultColors(7)=(R=255,G=255,B=255)
     DefaultColors(8)=(R=255,G=175)
     DefaultColors(9)=(R=255,G=255,B=255)
     DefaultColors(10)=(R=84,B=84)
     DefaultColors(11)=(R=255,G=175)
     DefaultColors(12)=(R=255,G=175)
}
