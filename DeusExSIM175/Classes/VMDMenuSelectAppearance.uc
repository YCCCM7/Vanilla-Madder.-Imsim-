...
var int CurMaleSkinIndex, MaxMaleSkinIndex, CurFemaleSkinIndex, MaxFemaleSkinIndex;
...
var VMDButtonPos PresetPos, SavePresetButtonPos;

var ButtonWindow ButtonPresetPrev, ButtonPresetNext;
var MenuUIEditWindow PresetEntry;
var MenuUILabelWindow PresetLabel;
var VMDMenuUIActionButtonWindow SavePresetButton;

var localized string SavedLabelText, SaveMaleButtonText, SaveFemaleButtonText,
...
function UpdatePlayerAppearance()
{
	...
	if (CurTrenchChestIndex == 20)
	{
		...
		else if ((CurFemaleSkinIndex != 0) && (CurFemaleSkinIndex != 3))
		{
			bChestUnavailable = true;
			ChestUse = Texture'JCDentonTex1';
		}
	...
	{
		if ((bFemale) && (CurFemaleSkinIndex != 0) && (CurFemaleSkinIndex != 3))
		{
			bPantsUnavailable = true;
			PantsUse = Texture'PantsTex3';
		}
		else if ((!bFemale) && (CurMaleSkinIndex != 0) && (CurMaleSkinIndex != 3))
		{
			bPantsUnavailable = true;
			PantsUse = Texture'PantsTex3';
		}
	...
	if (SavePresetButton != None) //!FlagNihilum
	{
		if (bFemale)
		{
...
function string RemovePackagePrefix(string S)
{
	...
	if (InStr(Trim, ".") == -1) return Trim;
	else return RemovePackagePrefix(Trim);
}
...
{
	local string Spaced, TS, NextTS, S1, S2;
	local int i;
	...
	if (Conv ~= "JoJoFine") return "JoJo Fine";
...
function bool ButtonActivated( Window buttonPressed )
{
	...
	switch( buttonPressed )
	{
		case ButtonGenderPrev:
			...
			if ((CurGenderIndex == 0) && (CurMalePresetIndex > 0))
			{
				LoadMalePreset(CurMalePresetIndex-1);
			}
			else if ((CurGenderIndex == 1) && (CurFemalePresetIndex > 0))
			{
		...
		case ButtonPresetPrev:
			if (bFemale)
			{
				...
				if (CurFemalePresetIndex < 0) CurFemalePresetIndex = 5;
			...
			{
				CurMalePresetIndex--;
				if (CurMalePresetIndex < 0) CurMalePresetIndex = 5;
		...
		case ButtonPresetNext:
			...
			{
				CurFemalePresetIndex++;
				if (CurFemalePresetIndex > 5) CurFemalePresetIndex = 0;
			...
			{
				CurMalePresetIndex++;
				if (CurMalePresetIndex > 5) CurMalePresetIndex = 0;
...
function SaveSettings()
{
	...
	if (bFemale)
	{
		Player.PlayerSkin = CurFemaleSkinIndex;
	}
	else
	{
		Player.PlayerSkin = CurMaleSkinIndex;
	}
...
defaultproperties
{
     ...
     MeshPos=(X=184,Y=82)
     SkinPos=(X=184,Y=128)
     LensesPos=(X=184,Y=211)
     FramesPos=(X=184,Y=257)
     ChestPos=(X=37,Y=188)
     CoatPos=(X=37,Y=234)
     PantsPos=(X=37,Y=280)
     ...
     PresetPos=(X=110,Y=328)
     SavePresetButtonPos=(X=110,Y=352)
     ...
     TrenchChestTexs(1)=Texture'DeusExCharacters.Skins.DoctorTex1'
     TrenchChestTexs(2)=Texture'DeusExCharacters.Skins.FordSchickTex1'
     TrenchChestTexs(3)=Texture'DeusExCharacters.Skins.GarySavageTex1'
     TrenchChestTexs(4)=Texture'DeusExCharacters.Skins.GilbertRentonTex1'
     TrenchChestTexs(5)=Texture'DeusExCharacters.Skins.JaimeReyesTex1'
     TrenchChestTexs(6)=Texture'DeusExCharacters.Skins.JockTex1'
     TrenchChestTexs(7)=Texture'DeusExCharacters.Skins.JosephManderleyTex1'
     TrenchChestTexs(8)=Texture'DeusExCharacters.Skins.JuanLebedevTex1'
     TrenchChestTexs(9)=Texture'DeusExCharacters.Skins.MaxChenTex1'
     TrenchChestTexs(10)=Texture'DeusExCharacters.Skins.PaulDentonTex1'
     TrenchChestTexs(11)=Texture'DeusExCharacters.Skins.SmugglerTex1'
     TrenchChestTexs(12)=Texture'DeusExCharacters.Skins.StantonDowdTex1'
     TrenchChestTexs(13)=Texture'DeusExCharacters.Skins.ThugMaleTex1'
     TrenchChestTexs(14)=Texture'DeusExCharacters.Skins.TobyAtanweTex1'
     TrenchChestTexs(15)=Texture'DeusExCharacters.Skins.TrenchShirtTex1'
     TrenchChestTexs(16)=Texture'DeusExCharacters.Skins.TrenchShirtTex2'
     TrenchChestTexs(17)=Texture'DeusExCharacters.Skins.TrenchShirtTex3'
     TrenchChestTexs(18)=Texture'DeusExCharacters.Skins.TriadRedArrowTex1'
     TrenchChestTexs(19)=Texture'DeusExCharacters.Skins.WaltonSimonsTex1'
     TrenchChestTexs(20)=Texture'DeusExCharacters.Skins.Female4Tex1'
     TrenchChestTexs(21)=Texture'VMDAssets.DDSTrenchShirtSlot01'
     TrenchChestTexs(22)=Texture'VMDAssets.DDSTrenchShirtSlot02'
     TrenchChestTexs(23)=Texture'VMDAssets.DDSTrenchShirtSlot03'
     TrenchChestTexs(24)=Texture'VMDAssets.DDSTrenchShirtSlot04'
     TrenchChestTexs(25)=Texture'VMDAssets.DDSTrenchShirtSlot05'
     MaxTrenchChestIndex=25
     ...
     TrenchCoatTexs(14)=Texture'DeusExCharacters.Skins.SmugglerTex2'
     TrenchCoatTexs(15)=Texture'DeusExCharacters.Skins.StantonDowdTex2'
     TrenchCoatTexs(16)=Texture'DeusExCharacters.Skins.ThugMaleTex2'
     TrenchCoatIsShort(16)=1
     TrenchCoatTexs(17)=Texture'DeusExCharacters.Skins.TobyAtanweTex2'
     TrenchCoatTexs(18)=Texture'DeusExCharacters.Skins.TrenchCoatTex1'
     TrenchCoatTexs(19)=Texture'DeusExCharacters.Skins.TriadRedArrowTex2'
     ...
     TrenchPantsTexs(35)=Texture'DeusExCharacters.Skins.RiotCopTex1'
     TrenchPantsTexs(36)=Texture'DeusExCharacters.Skins.SailorTex2'
     TrenchPantsTexs(37)=Texture'DeusExCharacters.Skins.SamCarterTex2'
     TrenchPantsTexs(38)=Texture'DeusExCharacters.Skins.SecretServiceTex2'
     TrenchPantsTexs(39)=Texture'DeusExCharacters.Skins.SoldierTex2'
     TrenchPantsTexs(40)=Texture'DeusExCharacters.Skins.ThugMale2Tex2'
     TrenchPantsTexs(41)=Texture'DeusExCharacters.Skins.ThugMale3Tex2'
     TrenchPantsTexs(42)=Texture'DeusExCharacters.Skins.ThugMaleTex3'
     TrenchPantsTexs(43)=Texture'DeusExCharacters.Skins.TiffanySavageTex2'
     TrenchPantsTexs(44)=Texture'DeusExCharacters.Skins.TracerTongTex2'
     TrenchPantsTexs(45)=Texture'DeusExCharacters.Skins.TriadRedArrowTex3'
