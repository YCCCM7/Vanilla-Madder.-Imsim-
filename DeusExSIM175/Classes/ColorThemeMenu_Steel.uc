//=============================================================================
// ColorThemeMenu_Steel
//=============================================================================

class ColorThemeMenu_Steel extends ColorThemeMenu;
...
defaultproperties
{
     ...
     DefaultColors(0)=(R=198,G=210,B=255)
     DefaultColors(1)=(G=77,B=255)
     DefaultColors(2)=(R=225,G=244,B=255)
     DefaultColors(3)=(R=218,G=239,B=255)
     DefaultColors(4)=(R=191,G=202,B=215)
     DefaultColors(5)=(R=255,G=255,B=255)
     DefaultColors(6)=(R=84,G=97,B=108)
     DefaultColors(7)=(R=191,G=202,B=215)
     DefaultColors(8)=(R=191,G=202,B=215)
     DefaultColors(9)=(R=255,G=255,B=255)
     DefaultColors(10)=(R=56,G=73,B=88)
     DefaultColors(11)=(R=113,G=128,B=139)
     DefaultColors(12)=(R=223,G=234,B=255)
}
