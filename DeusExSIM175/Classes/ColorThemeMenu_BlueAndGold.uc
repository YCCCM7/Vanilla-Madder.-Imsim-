//=============================================================================
// ColorThemeMenu_BlueAndGold
//=============================================================================

class ColorThemeMenu_BlueAndGold extends ColorThemeMenu;
...
defaultproperties
{
     ...
     DefaultColors(0)=(R=148,G=166,B=225)
     DefaultColors(1)=(R=169,G=182,B=231)
     DefaultColors(2)=(R=255,G=255,B=255)
     DefaultColors(3)=(R=255,G=242,B=89)
     DefaultColors(4)=(R=255,G=255,B=151)
     DefaultColors(5)=(R=255,G=255,B=239)
     DefaultColors(6)=(R=50,G=50,B=50)
     DefaultColors(7)=(R=199,G=218,B=241)
     DefaultColors(8)=(R=199,G=218,B=241)
     DefaultColors(9)=(R=255,G=255,B=239)
     DefaultColors(10)=(R=56,G=67,B=83)
     DefaultColors(11)=(R=228,G=202,B=100)
     DefaultColors(12)=(R=148,G=166,B=225)
}
