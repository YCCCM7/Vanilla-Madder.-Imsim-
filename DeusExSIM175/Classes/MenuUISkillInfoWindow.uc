...
//=============================================================================
class MenuUISkillInfoWindow extends Window;
...
function SetSkill(skill newSkill)
{
	...
	if ((VMP != None) && (VMP.IsSpecializedInSkill(Skill.Class)))
	{
		StrAdd = " (*)";
	}
	winSkillName.SetText(skill.SkillName$StrAdd);
...
event StyleChanged()
{
	...
	//MADDERS, 11/29/21: 
    	colSkillName = theme.GetColorFromName('MenuColor_ButtonTextNormal');
    	colSkillDesc = theme.GetColorFromName('MenuColor_ButtonTextNormal');
