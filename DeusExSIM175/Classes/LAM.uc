...
//MADDERS, 4/17/21: Mutations uses LAM damage quite precisely, so revert our damage values accordingly.
function PostBeginPlay()
{
	...
	VMP = VMDBufferPlayer(Instigator);
	if (VMP != None)
	{
...
defaultproperties
{
     ...
     Damage=200.000000 //Used to be 500, then 200, then 150
