//=============================================================================
// ColorThemeMenu_Pastel
//=============================================================================

class ColorThemeMenu_Pastel extends ColorThemeMenu;
...
defaultproperties
{
     ...
     DefaultColors(1)=(R=255,G=196,B=255)
     DefaultColors(2)=(R=250,G=250,B=131)
     DefaultColors(3)=(R=204,G=223,B=255)
     DefaultColors(4)=(R=244,G=255,B=161)
     DefaultColors(5)=(R=255,G=255,B=255)
     DefaultColors(6)=(R=100,G=100,B=100)
     DefaultColors(7)=(R=175,G=134,B=196)
     DefaultColors(8)=(R=175,G=113,B=175)
     DefaultColors(9)=(R=255,G=255,B=145)
     DefaultColors(10)=(R=100,G=100,B=124)
     DefaultColors(11)=(R=150,G=80,B=150)
     DefaultColors(12)=(R=255,G=188,B=255)
}
