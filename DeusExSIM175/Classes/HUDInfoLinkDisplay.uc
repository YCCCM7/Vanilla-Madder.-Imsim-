...
// HUDInfoLinkDisplay
//=============================================================================
class HUDInfoLinkDisplay extends HUDBaseWindow
	transient;
...
function SetSpeaker(String bindName, String displayName)
{
	...
	if (VMP != None)
	{
		switch(CAPS(VMP.DatalinkID))
		{
			case "REDSUN":
			case "REDSUN2020":
			case "REDSUN 2020":
				portraitStringName = "RedsunInfoPortraits." $ Left(bindName, 16);
			break;
			case "ZODIAC":
			...
			default:
				...
				if (bindName == "JosephManderley")
					portraitStringName = "Hotelcarone.InfoLinkPortraits.JosephManderley";
