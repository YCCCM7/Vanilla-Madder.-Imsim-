	...
	if (VMP.bCraftingSystemEnabled)
	{
		switch(CAPS(PresetNames[WithIndex]))
		{
			...
			case "BURGLAR":
				...
				SAM.UnlockSkillAugment("MeleeDoorCrackingAssassin");
			...
			case "INVADER":
				...
				SAM.UnlockSkillAugment("LockpickScoutNoise");
				SAM.UnlockSkillAugment("LockpickStartStealth");
				SAM.UnlockSkillAugment("LockpickPickpocket");
				SAM.UnlockSkillAugment("ElectronicsFailNoise");
			...
			case "HACKER":
				...
				ForceSkill(class'SkillWeaponPistol', 1, 1, 0);
				SAM.UnlockSkillAugment("ElectronicsKeypads");
			...
			case "PACIFIST":
				...
				ForceSkill(class'SkillMedicine', 1, 2, 1);
				ForceSkill(class'SkillComputer', 1, 1, 0);
				SAM.UnlockSkillAugment("SwimmingFallRoll");
				SAM.UnlockSkillAugment("SwimmingRoll");
	...
	else
	{
		switch(CAPS(PresetNames[WithIndex]))
		{
			...
			case "SURGEON":
				...
				SAM.UnlockSkillAugment("MeleeBatonHeadshots");
				SAM.UnlockSkillAugment("MedicineStress");
				SAM.UnlockSkillAugment("MedicineMedbotRecharge");
				SAM.UnlockSkillAugment("MedicineWraparound");
			break;
			case "SHADOW":
				ForceSkillSpecialization(0, class'SkillLockpicking');
...
defaultproperties
{
     ...
     PresetDescs(3)="Doors absolutely hate you. Handy with a crowbar, and half as handy with a lockpick, you keep a low presence, with the potential to kill off the occassional straggler. You aren't built for robust combat, but that won't matter long term.|n|nSkills: Weapons: Low Tech(2), Infiltration(1)|nTalents: Silent Takedown, True Assailant, Soft Spot, Brute Force, Coverup"
     ...
     PresetDescs(4)="Infiltration, hardware, and software... What more need be said? You can also pickpocket, and your ability to bypass obstacles often goes unnoticed.|n|nSkills: Infiltration(2), Hardware(1), Software(1)|nTalents: Soft Touch, Sleight of Hand, Silent Mode, Invader's Kit"
     Presets(4)=(SpecOne=5,SpecTwo=6,FreePoints=575,MinMax=75,Combat=0,Stealth=100,Difficulty=80)
     PresetNamesNoCrafting(4)="Invader"
     PresetDescsNoCrafting(4)="Infiltration, hardware, and software... What more need be said? You can also pickpocket, and your ability to bypass obstacles often goes unnoticed.|n|nSkills: Infiltration(2), Hardware(1), Software(1)|nTalents: Soft Touch, Sleight of Hand, Silent Mode, Invader's Kit"
     PresetsNoCrafting(4)=(SpecOne=5,SpecTwo=6,FreePoints=675,MinMax=75,Combat=0,Stealth=100,Difficulty=80)
     
     PresetNames(5)="Hacker"
     PresetDescs(5)="The digital realm has always spoken to you. While okay enough with a multitool, you really shine behind a keyboard, with a suite of software ready to go. You can bypass alarm units and keypads quite well, to your credit, and aren't half bad with a magnum.|n|nSkills: Hardware(1), Software(2), Weapons: Pistol(1)|nTalents: Codebreaker, Deep Fake, Wiz Kid, IFF Programming"
     ...
     PresetDescs(8)="You can reduce damage coming your way, and patch up any hits you DO end up taking. While certainly durable for good periods of time, your handgun is the only thing you pack to fight back, at least to start off with.|n|nSkills: Tactical Gear(2), Medicine(2)|nTalents: Off Switch, Fasten Up, Insulation, Trained Professional, Pharmacist, PHD In Chemistry"
     ...
     PresetDescsNoCrafting(8)="You can reduce damage coming your way, and patch up any hits you DO end up taking. While certainly durable for good periods of time, your handgun is the only thing you pack to fight back, at least to start off with.|n|nSkills: Tactical Gear(2), Medicine(2)|nTalents: Off Switch, Fasten Up, Insulation, Trained Professional, Pharmacist, Walking Closet"
     ...
     PresetDescs(13)="You're not here to fight, per se. You'd prefer not to take lives if you can help it. You are, however, quite good at mending wounds and cooking up your own supplies... Including a nasty little something called 'compound 23'... But that's for when shit hits the fan.|n|nSkills: Weapons: Hardware(1), Medicine(2), Low Tech(1)|nTalents: Medigel Treatment, Pharmacist, PHD In Chemistry, Compound 23, Silent Takedown, Dislodge"
     ...
     PresetDescsNoCrafting(13)="You're not here to fight, per se. You'd prefer not to take lives if you can help it, being handy with a baton in particular, but know how to retrieve darts from a victim, too. In particular, you know how to get maximum mileage from medkits and medbots.|n|nSkills: Weapons: Low Tech(1), Medicine(2), Hardware(1), Software(1)|nTalents: Pharmacist, Trained Professional, Walking Closet, Silent Takedown, Dislodge"
     ...
     PresetDescs(14)="They won't smell you, they won't notice you picking a lock, and they might not even notice you palming a weapon. You're dead silent, often hiding in plain sight. Should your plans fail, though, you'll likely have a vest on underneath.|n|nSkills: Tactical Gear(1), Infiltration(2), Weapons: Pistol(1)|nTalents: Off Switch, Low Profile, Soft Touch, Sleight of Hand, Coverup"
