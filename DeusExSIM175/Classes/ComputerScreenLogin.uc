...
function CreateControls()
{
	...
	editUserName = CreateMenuEditWindow(105, 20, 143, 32, winClient);
	editPassword = CreateMenuEditWindow(105, 54, 143, 32, winClient);
...
function ProcessLogin()
{
	...
	//MADDERS, 1/16/21: Don't allow default logs to actually work lmao.
	if ((EditUsername.GetText() ~= "User") && (EditPassword.GetText() ~= "User"))
	{
		UserIndex = -1;
	}
	if ((EditUsername.GetText() ~= "Security") && (EditPassword.GetText() ~= "Security"))
	{
		UserIndex = -1;
	}
