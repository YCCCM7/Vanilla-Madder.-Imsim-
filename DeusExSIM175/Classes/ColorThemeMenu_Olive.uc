//=============================================================================
// ColorThemeMenu_Olive
//=============================================================================

class ColorThemeMenu_Olive extends ColorThemeMenu;
...
defaultproperties
{
     ...
     DefaultColors(0)=(R=204,G=255,B=158)
     DefaultColors(1)=(R=191,G=242,B=51)
     DefaultColors(2)=(R=255,G=255,B=206)
     DefaultColors(3)=(R=217,G=255,B=148)
     DefaultColors(4)=(R=185,G=222,B=142)
     DefaultColors(5)=(R=253,G=255,B=242)
     DefaultColors(6)=(R=135,G=166,B=96)
     DefaultColors(7)=(R=253,G=255,B=242)
     DefaultColors(8)=(R=185,G=222,B=142)
     DefaultColors(9)=(R=253,G=255,B=242)
     DefaultColors(10)=(R=84,G=120,B=57)
     DefaultColors(11)=(R=207,G=255,B=137)
     DefaultColors(12)=(R=204,G=255,B=158)
}
