...
// GraySpawner.
//=============================================================================
class GraySpawner extends DeusExPickup;

function PostPostBeginPlay()
{
 local Vector THei, THei2;
 
 Super.PostPostBeginPlay();
 
 THei = vect(0,0,1) * CollisionHeight;
 THei2 = vect(0,0,1) * class'Gray'.Default.CollisionHeight;
 
 Spawn(class'Gray',,,Location - THei + THei2, Rotation);
 Destroy();
}
